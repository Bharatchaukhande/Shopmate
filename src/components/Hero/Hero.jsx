  ...
  return (
    ...
    <div className='Hero-container-1' >
      <div id='box1' className="box">
           ...
           <h1>Trends</h1>
           <p>Discover the latest trens & express your style effortlessly .shop exclusive
            collection with premium designs,just for you!
           </p>
           </div>
           ...
           <div className="bottom-heading">
            <h1>25 Million+</h1>
            <p>Real reviews from our happy customers!
                See what fashion lovers are saying about our quality,style ansd service
            </p>
           </div>
